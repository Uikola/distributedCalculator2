...
func (c *expressionServiceClient) Calculate(ctx context.Context, in *CalculateRequest, opts ...grpc.CallOption) (*CalculateResponse, error) {
	out := new(CalculateResponse)
	err := c.cc.Invoke(ctx, "/heartbeat.ExpressionService/Calculate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExpressionServiceServer) Calculate(context.Context, *CalculateRequest) (*CalculateResponse, error) {
...
func _ExpressionService_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/heartbeat.ExpressionService/Calculate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExpressionServiceServer).Calculate(ctx, req.(*CalculateRequest))
	}
...
var ExpressionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "heartbeat.ExpressionService",
	...
	Metadata: "proto/expression/expression.proto",
}
